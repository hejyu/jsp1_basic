...
//                  ㄴ private 필드, 값 초기화 커스텀생성자, getter, hashcode 와 equals 재정의
//                  ㄴ 객체 생성시 값을 초기화한 후 변경할 수 없으며, 필드값이 같으면 같은 값으로 처리되는 객체 
public class CustomerVO {        //tbl_custom 테이블의 컬럼과 1:1 대응되는 변수로 정의합니다
    ...
    // 아래 2개의 메소드가 재정의 되어야 진짜 VO 입니다.
    //      ㄴ 필드 값이 같으면 값이 같은 객체로 처리됩니다.
    @Override
    public int hashCode() {
        final int prime = 31;
        int result = 1;
